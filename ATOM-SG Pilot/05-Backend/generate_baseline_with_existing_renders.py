#!/usr/bin/env python3
"""
Generate baseline test using EXISTING high-quality renders from generate_renders.py
Uses the professional SVG/PDF renders already created.
"""
...
# Ensure renders exist - run generate_renders.py if needed
def ensure_renders():
    """Run generate_renders.py to create high-quality diagrams if they don't exist."""
    render_script = BACKEND_DIR / "generate_renders.py"
    if render_script.exists():
        print("Generating high-quality renders using existing render system...")
        result = subprocess.run([sys.executable, str(render_script)], 
                              capture_output=True, text=True, cwd=BACKEND_DIR)
        if result.returncode != 0:
            print(f"Warning: Render generation had issues: {result.stderr}")
        else:
            print("✓ High-quality renders generated")
    else:
        print(f"Warning: Render script not found at {render_script}")

# Problem definitions matching the baseline test
PROBLEMS = [
    # WORD PROBLEMS (20)
    ...
    # GEOMETRY (12) - Using existing high-quality renders
    {"num": 21, "id": "G001", "type": "G", "pathway": "Geometry-Angle", "diff": "E", 
     "text": "Measure the angles A, B, and C in the diagram using a protractor.", "ans": "See rubric", "render": "G001-angle-diagram-v1.svg"},
    {"num": 22, "id": "G002", "type": "G", "pathway": "Geometry-Angle", "diff": "E", 
     "text": "Two angles on a straight line are given. If one angle is 75°, find the other angle.", "ans": "105°", "render": "G002-angle-diagram-v1.svg"},
    {"num": 23, "id": "G005", "type": "G", "pathway": "Geometry-Triangle", "diff": "M", 
     "text": "In triangle ABC, angle A = 50° and angle B = 70°. Find angle C.", "ans": "60°", "render": "G005-triangle-v1.svg"},
    {"num": 24, "id": "G007", "type": "G", "pathway": "Geometry-Angle", "diff": "H", 
     "text": "Angle A and Angle B are on a straight line. Angle B and Angle C are complementary. If Angle A = 110°, find Angle C.", "ans": "20°", "render": "G007-angle-diagram-v1.svg"},
    {"num": 25, "id": "G009", "type": "G", "pathway": "Geometry-Perimeter", "diff": "E", 
     "text": "Find the perimeter of the rectangle shown in the diagram.", "ans": "26 cm", "render": "G009-rectangle-v1.svg"},
    {"num": 26, "id": "G010", "type": "G", "pathway": "Geometry-Composite", "diff": "M", 
     "text": "A rectilinear figure consists of two rectangles joined together. Find its perimeter.", "ans": "See rubric", "render": "G010-composite-shape-v1.svg"},
    {"num": 27, "id": "G011", "type": "G", "pathway": "Geometry-Area", "diff": "M", 
     "text": "Find the area of an L-shape figure formed by two rectangles.", "ans": "See rubric", "render": "G011-composite-shape-v1.svg"},
    {"num": 28, "id": "G014", "type": "G", "pathway": "Geometry-Conversion", "diff": "M", 
     "text": "Convert 2.5 square metres to square centimetres.", "ans": "25,000 cm²", "render": "G014-conversion-v1.svg"},
    {"num": 29, "id": "G017", "type": "G", "pathway": "Geometry-Volume", "diff": "E", 
     "text": "Find the volume of the cuboid shown in the diagram.", "ans": "72 cm³", "render": "G017-cuboid-v1.svg"},
    {"num": 30, "id": "G019", "type": "G", "pathway": "Geometry-3D", "diff": "M", 
     "text": "Which of the following nets can be folded to form a cube?", "ans": "See rubric", "render": "G019-net-v1.svg"},
    {"num": 31, "id": "G021", "type": "G", "pathway": "Geometry-Classify", "diff": "E", 
     "text": "Classify the triangle with side lengths 5 cm, 5 cm, 5 cm.", "ans": "Equilateral", "render": "G021-triangle-classification-v1.svg"},
    {"num": 32, "id": "G024", "type": "G", "pathway": "Geometry-Circle", "diff": "M", 
     "text": "A circle has radius 7 cm as shown. Find its circumference (take π = 22/7).", "ans": "44 cm", "render": "G024-circle-v1.svg"},
    
    # DATA INTERPRETATION (8) - Using existing renders
    {"num": 33, "id": "DI021", "type": "DI", "pathway": "DI-Bar Chart", "diff": "E", 
     "text": "The bar chart shows books read by 5 students. Who read the most books?", "ans": "Cal (15 books)", "render": "G025-pie-chart-v1.svg"},  # Placeholder - need bar chart
    {"num": 34, "id": "DI022", "type": "DI", "pathway": "DI-Bar Chart", "diff": "E", 
     "text": "Calculate the total number of books read by all students and find the average.", "ans": "Total: 51, Average: 10.2", "render": None},
    {"num": 35, "id": "DI023", "type": "DI", "pathway": "DI-Bar Chart", "diff": "M", 
     "text": "Find the mode and range of the number of books read from the chart.", "ans": "Mode: varies, Range: 9", "render": None},
    {"num": 36, "id": "DI024", "type": "DI", "pathway": "DI-Line Graph", "diff": "M", 
     "text": "The line graph shows temperature over a week. Identify the hottest day.", "ans": "Saturday (33°C)", "render": None},
    {"num": 37, "id": "DI025", "type": "DI", "pathway": "DI-Line Graph", "diff": "M", 
     "text": "Estimate the temperature on Wednesday afternoon using interpolation.", "ans": "Approximately 31°C", "render": None},
    {"num": 38, "id": "DI026", "type": "DI", "pathway": "DI-Line Graph", "diff": "H", 
     "text": "Compare the sales trends of Product A and Product B. Which showed more consistent growth?", "ans": "See graph", "render": None},
    {"num": 39, "id": "DI027", "type": "DI", "pathway": "DI-Pie Chart", "diff": "M", 
     "text": "The pie chart shows a sector with angle 72°. What fraction of the whole does this represent?", "ans": "1/5", "render": "G025-pie-chart-v1.svg"},
    {"num": 40, "id": "DI028", "type": "DI", "pathway": "DI-Pie Chart", "diff": "H", 
     "text": "Given that apples = 72° (60 apples), find the total number of fruits.", "ans": "300 fruits", "render": "G025-pie-chart-v1.svg"},
]
...
def add_svg_to_canvas(c, svg_path, x, y, width, height):
    """Add SVG render to canvas."""
    try:
        ...
        c.drawCentredString(x + width/2, y - height/2, "[Diagram]")
        return height
    return 0

def generate_pdf(output_path):
    # First ensure renders exist
    ensure_renders()
    ...
    c.drawString(lm, y, "Instructions: Show all working. Write answers in the boxes. Diagrams use professional renders.")
    y -= 0.18*inch
    ...
    for prob in PROBLEMS:
        ...
        if has_render:
            y -= 0.1*inch
            svg_path = RENDERS_DIR / prob["render"]
            img_width = 3.0 * inch
            img_height = 2.0 * inch
            x_pos = lm + (cw - img_width) / 2
            actual_height = add_svg_to_canvas(c, svg_path, x_pos, y, img_width, img_height)
            y -= actual_height + 0.1*inch
    ...
    print(f"   40 questions with professional SVG renders")

if __name__ == "__main__":
    output_path = OUTPUT_DIR / "ATOM-SG_Baseline_Test_PROFESSIONAL_RENDERS.pdf"
