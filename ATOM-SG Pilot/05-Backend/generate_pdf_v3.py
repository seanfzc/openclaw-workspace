#!/usr/bin/env python3
"""
Generate FINAL PDF v3.0 with ALL corrections
- 20 Word Problems (exam-quality language)
- 12 Geometry (each with unique VRS-compliant diagram)
- 8 Data Interpretation (each with unique chart)
"""
...
PROBLEMS = [
    ...
    {"num": 21, "type": "G", "pathway": "G5-Composite Overlap", "diff": "H",
     ...
     "answer": "(a) 127 cm² (b) 45.4 cm", "marks": 5, "diagram": "Q21_composite_overlap.png"},
    ...
    {"num": 22, "type": "G", "pathway": "G6-Grid Construction", "diff": "H",
     ...
     "answer": "(a) 36° (b) See diagram", "marks": 4, "diagram": "Q22_grid_protractor.png"},
    ...
    {"num": 23, "type": "G", "pathway": "G7-3D Visualization", "diff": "H",
     ...
     "answer": "(a) See diagram (b) 8 cubes", "marks": 4, "diagram": "Q23_3d_isometric.png"},
    
    {"num": 24, "type": "G", "pathway": "G8-Angle Chasing", "diff": "H",
     "text": "In the figure below, ABCD is a rhombus and ADEF is a trapezium with AF parallel to DE. Given angle DFE = 21°, angle BCD = 108° (reflex), and angle DAB = 33°, find the values of angles x and y marked in the diagram.",
    ...
    {"num": 25, "type": "G", "pathway": "G5-Composite Overlap", "diff": "M",
     ...
     "answer": "(a) 2 cm (b) 13 cm (c) 38 cubes", "marks": 5, "diagram": "Q25_five_squares.png"},
    ...
    {"num": 27, "type": "G", "pathway": "G8-Angle Chasing", "diff": "M",
     ...
     "answer": "155°", "marks": 2, "diagram": "Q27_angles_point.png"},
    
    {"num": 28, "type": "G", "pathway": "G1-Angle Reasoning", "diff": "M",
     "text": "Two straight lines intersect at point O as shown. If one of the angles formed is 40°, find the measures of angles a, b, and c marked in the diagram.",
     "answer": "a = 40°, b = 140°, c = 140°", "marks": 2, "diagram": "Q28_intersecting.png"},
    
    {"num": 29, "type": "G", "pathway": "G2-Area", "diff": "M",
     "text": "In triangle ABC shown, angle A measures 50° and angle B measures 70°. Find the measure of angle C.",
     "answer": "60°", "marks": 2, "diagram": "Q29_triangle.png"},
    ...
    {"num": 30, "type": "G", "pathway": "G2-Composite", "diff": "M",
     ...
     "answer": "(a) 64 cm² (b) 34 cm", "marks": 3, "diagram": "Q30_lshape.png"},
    ...
    {"num": 31, "type": "G", "pathway": "G2-Area", "diff": "M",
     ...
     "answer": "84 cm²", "marks": 3, "diagram": "Q31_rectangle_cut.png"},
    ...
    {"num": 32, "type": "G", "pathway": "G3-Volume", "diff": "M",
     ...
     "answer": "72 cm³", "marks": 2, "diagram": "Q32_cuboid.png"},
...
def generate_pdf():
    output_path = OUTPUT_DIR / "ATOM-SG_Exam_Quality_Baseline_40_Questions_v3.pdf"
    ...
    c.drawCentredString(width/2, height - tm, "ATOM-SG Exam-Quality Baseline Test v3.0")
    ...
    c.drawString(lm, y, "Instructions: Show all working. Each question has its own unique diagram. All diagrams are VRS-compliant.")
    y -= 0.18*inch
...
if __name__ == "__main__":
    print(f"\n{'='*60}")
    print("Generating Exam-Quality Baseline Test v3.0")
    print(f"{'='*60}")
    print(f"\nCorrections in v3.0:")
    print(f"  ✅ 12 Geometry diagrams - ALL unique, VRS-compliant")
    print(f"  ✅ 8 DI charts - ALL unique data sets")
    print(f"  ✅ Diagonal hatching for shaded regions")
    print(f"  ✅ Protractor overlays for measurement")
    print(f"  ✅ Reflex angle arcs (>180°)")
    print(f"  ✅ 3D isometric with orthographic views")
    print(f"  ✅ Each question explicitly references its diagram")
