#!/usr/bin/env python3
"""
Generate baseline test using EXISTING professional renders.
Uses the pre-generated high-quality SVG/PDF renders.
"""
...
PROBLEMS = [
    ...
    # GEOMETRY (12) - Using professional renders
    {"num": 21, "id": "G001", "type": "G", "pathway": "Geometry-Angle", "diff": "E", 
     "text": "Measure the angles A, B, and C in the diagram using a protractor.", "ans": "See rubric", "render": "G001-angle-diagram-v1.pdf"},
    {"num": 22, "id": "G002", "type": "G", "pathway": "Geometry-Angle", "diff": "E", 
     "text": "Two angles on a straight line are given. If one angle is 75°, find the other angle.", "ans": "105°", "render": "G002-angle-diagram-v1.pdf"},
    {"num": 23, "id": "G005", "type": "G", "pathway": "Geometry-Triangle", "diff": "M", 
     "text": "In triangle ABC, angle A = 50° and angle B = 70°. Find angle C.", "ans": "60°", "render": "G005-triangle-v1.pdf"},
    {"num": 24, "id": "G007", "type": "G", "pathway": "Geometry-Angle", "diff": "H", 
     "text": "Angle A and Angle B are on a straight line. Angle B and Angle C are complementary. If Angle A = 110°, find Angle C.", "ans": "20°", "render": "G007-angle-diagram-v1.pdf"},
    {"num": 25, "id": "G009", "type": "G", "pathway": "Geometry-Perimeter", "diff": "E", 
     "text": "Find the perimeter of the rectangle shown in the diagram.", "ans": "26 cm", "render": "G009-rectangle-v1.pdf"},
    {"num": 26, "id": "G010", "type": "G", "pathway": "Geometry-Composite", "diff": "M", 
     "text": "A rectilinear figure consists of two rectangles joined together. Find its perimeter.", "ans": "See rubric", "render": "G010-composite-shape-v1.pdf"},
    {"num": 27, "id": "G011", "type": "G", "pathway": "Geometry-Area", "diff": "M", 
     "text": "Find the area of an L-shape figure formed by two rectangles.", "ans": "See rubric", "render": "G011-composite-shape-v1.pdf"},
    {"num": 28, "id": "G014", "type": "G", "pathway": "Geometry-Conversion", "diff": "M", 
     "text": "Convert 2.5 square metres to square centimetres.", "ans": "25,000 cm²", "render": "G014-conversion-v1.pdf"},
    {"num": 29, "id": "G017", "type": "G", "pathway": "Geometry-Volume", "diff": "E", 
     "text": "Find the volume of the cuboid shown in the diagram.", "ans": "72 cm³", "render": "G017-cuboid-v1.pdf"},
    {"num": 30, "id": "G019", "type": "G", "pathway": "Geometry-3D", "diff": "M", 
     "text": "Which of the following nets can be folded to form a cube?", "ans": "See rubric", "render": "G019-net-v1.pdf"},
    {"num": 31, "id": "G021", "type": "G", "pathway": "Geometry-Classify", "diff": "E", 
     "text": "Classify the triangle with side lengths 5 cm, 5 cm, 5 cm.", "ans": "Equilateral", "render": "G021-triangle-classification-v1.pdf"},
    {"num": 32, "id": "G024", "type": "G", "pathway": "Geometry-Circle", "diff": "M", 
     "text": "A circle has radius 7 cm as shown. Find its circumference (take π = 22/7).", "ans": "44 cm", "render": "G024-circle-v1.pdf"},
    
    # DATA INTERPRETATION (8)
    {"num": 33, "id": "DI021", "type": "DI", "pathway": "DI-Bar Chart", "diff": "E", 
     "text": "The bar chart shows books read by 5 students. Who read the most books?", "ans": "Cal (15 books)", "render": "G025-pie-chart-v1.pdf"},
    ...
    {"num": 39, "id": "DI027", "type": "DI", "pathway": "DI-Pie Chart", "diff": "M", 
     "text": "The pie chart shows a sector with angle 72°. What fraction of the whole does this represent?", "ans": "1/5", "render": "G025-pie-chart-v1.pdf"},
    {"num": 40, "id": "DI028", "type": "DI", "pathway": "DI-Pie Chart", "diff": "H", 
     "text": "Given that apples = 72° (60 apples), find the total number of fruits.", "ans": "300 fruits", "render": "G025-pie-chart-v1.pdf"},
]
...
def generate_pdf(output_path):
    ...
    c.drawString(lm, y, "Instructions: Show all working. Professional-grade diagrams included with questions.")
    y -= 0.18*inch
    ...
    print(f"   40 questions with professional renders")

if __name__ == "__main__":
    output_path = OUTPUT_DIR / "ATOM-SG_Baseline_Test_PROFESSIONAL.pdf"
